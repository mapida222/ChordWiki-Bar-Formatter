...
assert(readme.includes("### 変換例"));
assert(readme.includes("![変換前](docs/images/readme-conversion.png)"));
assert(readme.includes("![行修正](docs/images/readme-row-edit.png)"));
assert(readme.includes("![譜面プレビュー](docs/images/readme-score-preview.png)"));
