...
assert(html.includes("<h3>関連リンク <span>/ LINKS</span></h3>"));
assert(html.includes('aria-label="GitHub（ソースコード・更新情報）"'));
...
assert(css.includes(".community-github { grid-column: 1 / -1; height: 42px; min-height: 42px;"));
