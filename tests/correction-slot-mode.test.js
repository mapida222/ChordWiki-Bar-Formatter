...
assert(app.includes("correctionSymbolOffset = start;"), "symbol input must use the current visible beat slot rather than a stale boundary offset");
...
assert(app.includes("let correctionSymbolOffset = -1;"));
...
assert(html.includes('js/correction-input.js?v=20260802-10'));
