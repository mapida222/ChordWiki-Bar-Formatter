...
assert(entry.includes('import "../measure-check.js?v=20260905-013"'));
assert(entry.includes('import "../committed-measure-check-panel.js?v=20260905-013"'));
const panel = fs.readFileSync(path.join(root, "js", "committed-measure-check-panel.js"), "utf8");
assert(panel.includes("checker?.validate(output.value, { meterOverrides: currentMeterOverrides() })"));
...
assert(panel.includes("4/4として保管"));
