...
assert(entry.includes('import "../measure-check.js?v=20260919-001"'));
assert(entry.includes('import "../committed-measure-check-panel.js?v=20260919-001"'));
...
assert(panel.includes("meter?.capacity ?? result.expectedBeats"), "the summary must use each inline meter's beat capacity");
assert(panel.includes("拍子ごとの基準"), "mixed inline meters must be summarized by their own beat capacities");
