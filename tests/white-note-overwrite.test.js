...
assert.deepStrictEqual(CBFCorrectionInput.whiteNoteEdit("4s4", 0, 1), { start: 0, end: 2, replacement: "@", caret: 1 });
assert.deepStrictEqual(CBFCorrectionInput.whiteNoteEdit("4s4", 2, 3), { start: 1, end: 3, replacement: "@", caret: 2 });
