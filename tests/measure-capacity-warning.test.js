...
assert(app.includes('formattingDetails.push(detail("コード直後（空白区切り前）", formatting.hyphenUnit, values.hyphenUnit));'));
assert(app.includes('formattingDetails.push(detail("空白区切り後のグループ", formatting.hyphenSpacing, values.hyphenSpacing));'));
