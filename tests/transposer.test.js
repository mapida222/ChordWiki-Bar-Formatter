...
assert.strictEqual(transposer.transposeText("abcdef", 0, "preserve", false), "abcdef", "text without chord or key sections must remain safe before preview conversion");
