...
assert(html.includes("style.css?v=20260803-49"), "the browser must load the current linked-code highlight style");
assert(html.includes("js/app.js?v=20260803-40"), "the browser must load the current linked-code mapping");
