...
assert(html.includes("style.css?v=20260802-43"), "the browser must load the current linked-code highlight style");
assert(html.includes("js/app.js?v=20260802-38"), "the browser must load the current linked-code mapping");
