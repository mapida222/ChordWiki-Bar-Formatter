...
assert(html.includes('id="history-save-completed-test"'));
...
assert(app.includes('$("#history-save-completed-test").addEventListener("click", saveCompletedScoreAsTestHistory)'));
