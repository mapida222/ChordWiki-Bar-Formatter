...
「02. 変換前」へChordPro形式のテキストを貼り付けます。迷った場合は、画面の「入力サンプル」から試せます。

![コード譜を貼り付けた変換画面](docs/images/readme-conversion.png)

### 2. 曲に合わせて直す

自動変換された結果を見て、曲と合わない行だけ「04. 行修正」の数字や記号を調整します。

![行修正と変換結果](docs/images/readme-row-edit.png)

### 3. 譜面で確認して確定する

「06. 譜面プレビュー」で小節、コード、歌詞の見え方を確認します。必要なら移調し、「譜面プレビューを確定」してコピーします。
